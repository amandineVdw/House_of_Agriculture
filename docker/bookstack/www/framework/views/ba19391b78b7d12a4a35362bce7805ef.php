...
<html lang="<?php echo e($locale->htmlLang()); ?>">
<head>
                    ...
                    <tr>
                        <td style="<?php echo e($style['email-wrapper']); ?>" align="center">
                            <table width="100%" cellpadding="0" cellspacing="0">
                                        ...
                                        <table style="<?php echo e($style['email-body_inner']); ?>" align="center" width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="<?php echo e($fontFamily); ?> <?php echo e($style['email-body_cell']); ?>">
                                                    ...
                                                    <!-- Greeting -->
                                                    <?php if(!empty($greeting) || $level == 'error'): ?>
                                                        ...
                                                        <table style="<?php echo e($style['body_sub']); ?>">
                                                            <tr>
                                                                <td style="<?php echo e($fontFamily); ?>">
                                                                    <p style="<?php echo e($style['paragraph-sub']); ?>">
                                                                        <?php echo e($locale->trans('common.email_action_help', ['actionText' => $actionText])); ?>
                                ...
                                <tr>
                                    <td>
                                        <table style="<?php echo e($style['email-footer']); ?>" align="center" width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="<?php echo e($fontFamily); ?> <?php echo e($style['email-footer_cell']); ?>">
                                                    <p style="<?php echo e($style['paragraph-sub']); ?>">
                                                        &copy; <?php echo e(date('Y')); ?>

                                                        <a style="<?php echo e($style['anchor']); ?>" href="<?php echo e(url('/')); ?>" target="_blank"><?php echo e(setting('app-name')); ?></a>.
                                                        <?php echo e($locale->trans('common.email_rights')); ?>
...
<?php /**PATH /app/www/resources/views/vendor/notifications/email.blade.php ENDPATH**/ ?>