...
<head>
    ...
    <title>Error: <?php echo e($error); ?></title>
    ...
    <div class="container">
        ...
        <div class="panel">
            ...
            <ul>
                ...
                <li>
                    <a href="https://github.com/BookStackApp/BookStack/issues?q=is%3Aissue+<?php echo e(urlencode($error)); ?>" target="_blank">Search for the issue on GitHub &raquo;</a>
                </li>
                <li>
                    <a href="https://discord.gg/ztkBqR2" target="_blank">Ask for help via Discord &raquo;</a>
                </li>
                <li>
                    <a href="https://duckduckgo.com/?q=<?php echo e(urlencode("BookStack {$error}")); ?>" target="_blank">Search the error message &raquo;</a>
                </li>
            </ul>
        </div>
        ...
        <div class="panel">
            ...
            <ul>
                <?php $__currentLoopData = $environment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label => $text): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li><strong><?php echo e($label); ?>:</strong> <?php echo e($text); ?></li>
...
</html><?php /**PATH /app/www/resources/views/errors/debug.blade.php ENDPATH**/ ?>